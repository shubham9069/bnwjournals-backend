  ...
  try {
    ...
    if (userLogin) {
      ...
      if (!isMatch) {
        ...
        res.cookie("jwtoken",refreshToken , {HttpOnly: true, sameSite:'none',secure:true, maxAge:1000*24*60*60 });
...
res.clearCookie("jwtoken", { domain:'https://brown-dhole-tie.cyclic.app',path: "/" ,HttpOnly: true,sameSite:'none',secure:true,});
